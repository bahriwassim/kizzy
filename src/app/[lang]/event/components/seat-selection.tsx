...
const content = {
  fr: {
    ...
    tableDesc: 'Salon avec accès de 2 à 5 personnes inclus, bouteille au choix',
    entryDesc: 'Accès standard, buffet et open bulle de 22h à 0h inclus',
  ...
  en: {
    ...
    tableDesc: 'The salon has 2 to 5 people in total, close to your choice.',
    entryDesc: 'Accès standard, buffet and open bulb from 22 hours to 0 hours incl.',
